...
function TaskList() {
  ...
  const handleEdit = (taskId, taskTitle, taskDescription, taskStatus) => {
    setTaskId(taskId);
  ...
  const handleComplete = (taskId, title, description) => {
    dispatch(editTask(taskId, title, description, "completed"));
    setOpenDropdownId(null);
  };
              ...
              {task.status !== "completed" && (
                <button
                  className="block w-full py-2 px-4
                                                    text-left hover:bg-gray-100"
                  onClick={() =>
                    handleComplete(task._id, task.title, task.description)
                  }
                >
                  Mark as Completed
                </button>
